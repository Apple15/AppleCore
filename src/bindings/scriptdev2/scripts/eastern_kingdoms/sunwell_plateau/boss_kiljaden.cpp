...
#define TEXT_SAY_KJ_DARKNESS1	"Chaos!"
#define TEXT_SAY_KJ_DARKNESS2	"Destruction!"
#define TEXT_SAY_KJ_DARKNESS3	"Oblivion!"

#define TEXT_SAY_KJ_PHASE3		"I will not be denied! This world shall fall!"
#define TEXT_SAY_KJ_PHASE4		"Do not harbor false hope. You cannot win!"
#define TEXT_SAY_KJ_PHASE5		"Aggghh! The powers of the Sunwell... turn... against me! What have you done? What have you done???"

#define TEXT_SAY_KJ_DEATH		"Nooooooooooooo!"
...
struct MANGOS_DLL_DECL boss_kiljadenAI : public Scripted_NoMovementAI
{
    ...
    {
		m_creature->MonsterYell(TEXT_SAY_KJ_DEATH, LANG_UNIVERSAL, NULL);
    ...
    void UpdateAI(const uint32 diff)
    {
        ...
        if((m_uiKalecgosTimer < diff) && !m_bIsKalecgosSpawned)
        {
            ...
            if(Creature* cKalecgos = m_creature->SummonCreature(ID_KALECGOS, m_creature->GetPositionX(), m_creature->GetPositionY(), m_creature->GetPositionZ()+35, 0.686f, TEMPSUMMON_TIMED_DESPAWN, 600000))
            {
        ...
        if(m_uiDarknessOfSoulsTimer < diff && m_bPhase3)
        {
            switch (rand()%3)
		        {
			        case 0: DoPlaySoundToSet(m_creature, SAY_KJ_DARKNESS1); m_creature->MonsterYell(TEXT_SAY_KJ_DARKNESS1, LANG_UNIVERSAL, NULL); break;
			        case 1: DoPlaySoundToSet(m_creature, SAY_KJ_DARKNESS2); m_creature->MonsterYell(TEXT_SAY_KJ_DARKNESS2, LANG_UNIVERSAL, NULL); break;
			        case 2: DoPlaySoundToSet(m_creature, SAY_KJ_DARKNESS3); m_creature->MonsterYell(TEXT_SAY_KJ_DARKNESS3, LANG_UNIVERSAL, NULL); break;
		        }
        ...
        {   
			m_creature->MonsterYell(TEXT_SAY_KJ_PHASE3, LANG_UNIVERSAL, NULL);
        ...
        {
			m_creature->MonsterYell(TEXT_SAY_KJ_PHASE4, LANG_UNIVERSAL, NULL);
        ...
        {
			m_creature->MonsterYell(TEXT_SAY_KJ_PHASE5, LANG_UNIVERSAL, NULL);
